...
option (ARCH_BROADWELL "Add -march=broadwell compiler flag. Intel Broadwell CPU with 64-bit extensions, MOVBE, MMX, SSE, SSE2, SSE3, SSSE3, SSE4.1, SSE4.2, POPCNT, AVX, AVX2, AES, PCLMUL, FSGSBASE, RDRND, FMA, BMI, BMI2, F16C, RDSEED, ADCX and PREFETCHW instruction set support." 0)

if (ARCH_BROADWELL)
    set (COMPILER_FLAGS "${COMPILER_FLAGS} -march=broadwell")
else ()
