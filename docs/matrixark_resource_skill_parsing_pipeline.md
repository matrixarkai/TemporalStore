...
This gives MatrixArk baseline-like resource handling, baseline-like event/entity memory, and stronger MatrixArk-specific replay/debug governance in one TemporalStore-native model.
