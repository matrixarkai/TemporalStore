...
MATRIXARK_EMBEDDING_PROVIDER=oss MATRIXARK_REQUIRE_OSS_EMBEDDINGS=1 MATRIXARK_EMBEDDING_MODEL_PATH=/root/src/github-services/TemporalStore/.local/context-oss-models/sentence-transformers/all-MiniLM-L6-v2 PYTHONPATH=. TEMPORALSTORE_LIB=/root/src/github-services/TemporalStore/output-ubuntu22/release/sdk/lib/libbcache2.so python3 tools/run_matrixark_query_index_debug_flow.py   --backend temporalstore-direct   --metaserver 127.0.0.1:18000   --namespace deploy_ns   --table deploy_table   --temporalstore-lib /root/src/github-services/TemporalStore/output-ubuntu22/release/sdk/lib/libbcache2.so   --storage-prefix matrixark:cpp:query:index:debug:$(date +%s%3N)   --artifact-dir .local/context-debug/query-index-cpp-direct-debug
```
