...
|8691|context_summary||tenant:tenant_codex / user:deeproute :: assistant: -- {"type:agent-turn-complete,thread-id:019efad7-2f87-77e1-b082-c294fcb5e731,turn-id:019f9210-da61-7aa0-b711-b39eae2c2061,cwd:C:\\Users\\example\\Documents\\Codex\\...|
|8690|context_summary_dirty|||
|8688|context_summary||Context node tenant:tenant_codex. Rich overview: tenant:tenant_codex / user:deeproute :: user: TODAY WE ONLY SUPPORT CODEX HOOK, LEAVE TODOS FOR CLAUDE CODE AND OTHER AGENT tool: {"cwd": "C:\\Users\\example\\Documen...|
|8686|context_summary||tenant:tenant_codex :: tenant:tenant_codex / user:deeproute :: user: TODAY WE ONLY SUPPORT CODEX HOOK, LEAVE TODOS FOR CLAUDE CODE AND OTHER AGENT tool: {"cwd": "C:\\Users\\example\\Documents\\Codex\\2026-06-07\\use...|
