...
This gives MatrixArk both online freshness and VikingMem-style batch memory quality without requiring Codex itself to understand MatrixArk internal capabilities.
