...
| `blob://...` | Object-store-compatible adapter | Functional when the compatibility library is linked. |
| `local://...` | Object-store-compatible adapter | Functional when the compatibility library is linked. |
...
stream/page/index/oplog
  -> StoreLayer
     ...
     -> local://      Object-store-compatible Store
     -> s3://         S3 Store adapter
