...
| `context_resource_skill_parser_openviking_parity` | Rust-executable/C++-static gate for OpenViking-style resource chunking, stable source refs, `SKILL.md` front matter, capability/tool/instruction refs, chunk embeddings, and Rust TemporalStore ingestion/retrieval of parsed chunks. |
