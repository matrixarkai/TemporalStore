...
- storage prefix: `matrixark:dataset:locomo:locomo_cpp_native_scopekey_fix`
...
- answer hit: `0.1000`
- answer support hit: `0.7000`
- final judge score debug: `0.7000`
- answer-bearing token density: `0.0035`
- judge score per 1K tokens: `0.1331`
- evidence session recall: `0.5500`
- ingestion throughput turns/sec: `730.306`
- retrieval p50 ms: `83.585`
- retrieval p95 ms: `116.251`
