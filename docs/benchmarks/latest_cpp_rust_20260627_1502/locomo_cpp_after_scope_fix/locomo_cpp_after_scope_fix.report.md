...
- storage prefix: `matrixark:dataset:locomo:locomo_cpp_after_scope_fix`
...
- ingestion throughput turns/sec: `584.136`
- retrieval p50 ms: `71.256`
- retrieval p95 ms: `81.940`
