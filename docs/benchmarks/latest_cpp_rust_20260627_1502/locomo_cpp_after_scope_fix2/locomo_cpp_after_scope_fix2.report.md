...
- storage prefix: `matrixark:dataset:locomo:locomo_cpp_after_scope_fix2`
...
- ingestion throughput turns/sec: `578.136`
- retrieval p50 ms: `69.339`
- retrieval p95 ms: `82.151`
