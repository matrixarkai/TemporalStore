...
- status: `passed`
- corpus: `/root/src/github-services/TemporalStore/sdk/unified/temporalstore_unified_corpus.json`
- cases: `11`
- command kinds: `33`
- context steps: `43`
...
| --- | --- | ---: | --- |
| python_schema | `passed` | `0.052` | `/usr/bin/python3 tools/run_temporalstore_unified_tests.py --corpus /root/src/github-services/TemporalStore/sdk/unified/temporalstore_unified_corpus.json --validate-only` |
| cpp_context_contract | `passed` | `3.084` | `bash tools/run_cpp_unified_context_contract.sh /root/src/github-services/TemporalStore/sdk/unified/temporalstore_unified_corpus.json` |
