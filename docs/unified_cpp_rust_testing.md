...
KV, hash, packed timestamped feature pages, sequence rows, IPS, control_state, context,
...
coverage tied to Rust Redis, Feature, Sequence, IPS, ControlState, Context, and SDK
evidence.
