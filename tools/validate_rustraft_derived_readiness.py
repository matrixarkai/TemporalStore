        ...
        evidence=(
            Evidence(
                ...
                (
                    ...
                    'rev = "fa16941f7bb33807cdc1a8178d93d342b382a6aa"',
                ),
            ),
            Evidence(
                "Cargo.toml",
        ...
        evidence=(
            Evidence(
                ...
                (
                    ...
                    "raft_storage_apply_fence",
                    "validate_raft_apply_snapshot_fence",
                    "validate_raft_storage_apply_fence",
                    "ApplySnapshotFence",
                    "wal_backed_apply_snapshot_fence_survives_snapshot_restart",
                    "wal_backed_storage_apply_fence_survives_snapshot_restart",
                    "wal_recovery_rejects_missing_storage_apply_fence",
            ...
            Evidence(
                "docs/distributed_raft_readiness.md",
                (
                    "durable apply/snapshot fence",
                    "storage-aware apply fence",
                    "applied-index/storage/snapshot atomicity contract",
                ),
            ),
        ),
    ),
        ...
        evidence=(
            Evidence(
                ...
                (
                    ...
                    "install_snapshot_with_lifecycle_report",
            ...
            Evidence(
                "docs/distributed_raft_readiness.md",
                (
                    "snapshot-tail catch-up",
                    "data-node snapshot lifecycle reports",
                    "replicas receive the leader snapshot floor",
                ),
            ),
        ),
    ),
