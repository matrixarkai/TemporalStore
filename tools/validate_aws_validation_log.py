...
def validate_context_workflow(job, summary):
    ...
    require(summary["benchmark_mean_reciprocal_rank"] >= 1.0, f"{job}: context benchmark MRR regressed below 1.0")
    ...
    require(summary["benchmark_sweep_min_mean_reciprocal_rank"] >= 1.0, f"{job}: context benchmark sweep MRR regressed below 1.0")
    ...
    require(summary["external_benchmark_mean_reciprocal_rank"] > 0.0, f"{job}: external context benchmark MRR missing")
