...
ENV_MAP: Dict[str, str] = {
    ...
    "retrieval.shared_resource_max_budget_ratio": "MATRIXARK_SHARED_RESOURCE_MAX_BUDGET_RATIO",
    "retrieval.shared_skill_max_budget_ratio": "MATRIXARK_SHARED_SKILL_MAX_BUDGET_RATIO",
    "retrieval.cross_session_profile_max_budget_ratio": "MATRIXARK_CROSS_SESSION_PROFILE_MAX_BUDGET_RATIO",
