...
follower_read_sla_command='env BUILD_TYPE="${BUILD_TYPE}" RESULT_DIR="${RESULT_DIR}/follower_read_sla" PROBE_OPS=120 PROBE_THREADS=2 BACKGROUND_WRITER_THREADS=1 BACKGROUND_READER_THREADS=2 BENCH_TIMEOUT_S=180 MAX_SECONDARY_VISIBILITY_P99_US=50000 bash tools/run_follower_read_sla_ubuntu22.sh'
