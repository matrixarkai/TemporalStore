...
register_gap 05 "Dedicated rebalance harness" manual planned "tools/run_rebalance_local_ubuntu22.sh" "" "No dedicated rebalance runner is present yet; keep this as a blocking planned item before declaring rebalance production-ready."
