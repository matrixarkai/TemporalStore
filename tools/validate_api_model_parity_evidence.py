...
AREAS: tuple[ApiModelArea, ...] = (
    ...
    ApiModelArea(
        ...
        command_kinds=("feature_append", "feature_query", "sequence_add", "sequence_query"),
        response_kinds=("feature_points", "sequence_rows"),
        rust_evidence=(
            RustEvidence(
                "crates/temporalstore-rust/src/types.rs",
                ("FeatureAppend", "FeatureAppendWithPolicy", "SequenceAdd", "SequenceQuery"),
            ),
            RustEvidence(
