...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--min-backend-qps-ratio", type=float, default=float(os.environ.get("MATRIXARK_BACKFILL_BENCH_MIN_BACKEND_QPS_RATIO", "").strip() or "0"), help="optional parity floor: slowest selected backend QPS divided by fastest selected backend QPS, 0 disables")
