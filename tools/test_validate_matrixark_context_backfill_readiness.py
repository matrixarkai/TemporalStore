...
class MatrixArkContextBackfillReadinessTest(unittest.TestCase):
    ...
    def test_static_readiness_checks_cover_public_surface(self) -> None:
        ...
        self.assertTrue(names["backfill_has_local_recovery_report_mode"])
        ...
        self.assertTrue(names["backfill_has_active_prefix_precondition_bypass_confirmation"])
        ...
        self.assertTrue(names["manual_mentions_--confirm-rollback-noop"])
        self.assertTrue(names["manual_mentions_--expect-active-prefix"])
        self.assertTrue(names["manual_mentions_--confirm-no-active-prefix-precondition"])
    ...
    def test_local_readiness_gate_runs_batch_sweep_for_both_raw_backends(self) -> None:
        ...
        self.assertTrue(names["cutover_gate_blocks_noop_rollback"])
        self.assertTrue(names["cutover_gate_noop_rollback_is_explicitly_audited"])
        ...
        self.assertTrue(names["prometheus_gate_local_recovery_metrics_present"])
