...
def main() -> int:
    ...
    if backend in {"mysql", "matrixkv_sql", "matrixkv_sql"} and not dsn:
        raise SystemExit("MATRIXARK_METADATA_DSN is required for mysql/matrixkv_sql/matrixkv_sql probe")
