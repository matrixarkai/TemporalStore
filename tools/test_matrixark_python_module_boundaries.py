...
class MatrixArkPythonModuleBoundaryTest(unittest.TestCase):
    ...
    def test_mcp_entrypoint_reexports_split_modules(self) -> None:
        ...
        retrieve_compression_scan_mod = importlib.import_module("tools.matrixark_mcp_retrieve_compression_scan")
        ...
        retrieve_request_mod = importlib.import_module("tools.matrixark_mcp_retrieve_request")
        ...
        ingest_skill_records_mod = importlib.import_module("tools.matrixark_mcp_ingest_skill_records")
        ingest_resource_facts_mod = importlib.import_module("tools.matrixark_mcp_ingest_resource_facts")
        ingest_resource_queue_mod = importlib.import_module("tools.matrixark_mcp_ingest_resource_queue")
        ingest_resource_chunks_mod = importlib.import_module("tools.matrixark_mcp_ingest_resource_chunks")
        ingest_resource_summary_mod = importlib.import_module("tools.matrixark_mcp_ingest_resource_summary")
        ingest_resource_chunk_records_mod = importlib.import_module("tools.matrixark_mcp_ingest_resource_chunk_records")
        ingest_resource_runtime_mod = importlib.import_module("tools.matrixark_mcp_ingest_resource_runtime")
        ...
        self.assertTrue(callable(ingest_skill_records_mod.skill_manifest_record))
        ...
        self.assertTrue(callable(ingest_resource_queue_mod.queue_resource_import_if_needed))
        self.assertTrue(callable(ingest_resource_chunks_mod.normalize_resource_chunks))
        self.assertTrue(callable(ingest_resource_summary_mod.append_resource_summary_and_indexes))
        self.assertTrue(callable(ingest_resource_chunk_records_mod.append_resource_chunk_records))
        self.assertTrue(callable(ingest_resource_runtime_mod.ingest_resource_or_skill_if_needed))
        ...
        self.assertTrue(callable(retrieve_request_mod.prepare_retrieval_request))
        ...
        self.assertTrue(callable(retrieve_compression_scan_mod.scan_compression_candidates))
