...
COMPAT_ROOT="${COMPAT_ROOT:-<workspace>/Codex/2026-06-06/set-up-wsl-with-ubuntu-2022/work/cmake-glue/compat-include}"
BRPC_STATIC_LIBRARY="${BRPC_STATIC_LIBRARY:-<workspace>/Codex/2026-06-10/pull-rust-temporalstore-code-from-matrixarkai/work/TemporalStore/build-ubuntu22/_open_source_brpc/output/lib/libbrpc.a}"
...
if [[ "${FORCE_BUILD}" == "1" || ! -x "${BIN}" ]]; then
  ...
  MATRIXOBJECTSTORE_COMPAT_INCLUDE_DIR="${MATRIXOBJECTSTORE_COMPAT_INCLUDE_DIR:-${COMPAT_ROOT}}" \
