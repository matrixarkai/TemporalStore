...
FAMILIES: dict[str, FamilyConfig] = {
    "storage/cache": FamilyConfig(
        ...
        (
            "crates/temporalstore-rust/src/shared_store.rs::shared_store_defaults_to_async_storage_and_allows_explicit_sync",
        ),
        "cargo test -p temporalstore-rust shared_store_defaults_to_async_storage_and_allows_explicit_sync -- --test-threads=1",
        ("cpp_storage_parity",),
    ),
    "Raft": FamilyConfig(
        "Raft",
    ...
    "Sequence": FamilyConfig(
        ...
        ("crates/temporalstore-rust/src/engine.rs::sequence_add_packs_many_timestamp_values_into_one_page",),
        "cargo test -p temporalstore-rust sequence_add_packs_many_timestamp_values_into_one_page -- --test-threads=1",
        (),
    ),
    "IPS": FamilyConfig(
        "IPS",
        ("ips_options_range", "ips_snapshot_stat_filter_batch"),
        ("crates/temporalstore-rust/src/engine.rs::ips_load_snapshot_stat_and_filter_match_cpp_style_module_shape",),
        "cargo test -p temporalstore-rust ips_load_snapshot_stat_and_filter_match_cpp_style_module_shape -- --test-threads=1",
        (),
    ),
    "Risk": FamilyConfig(
        "Risk",
        ("risk_counter_window", "risk_family_query_and_delete", "risk_manager_debug_fol"),
        ("crates/temporalstore-rust/src/engine.rs::risk_cpp_family_set_query_setandget_and_manager_work",),
        "cargo test -p temporalstore-rust risk_cpp_family_set_query_setandget_and_manager_work -- --test-threads=1",
        (),
    ),
    "context": FamilyConfig(
        ...
        (
            "crates/temporalstore-rust/src/engine.rs::context_models_match_cpp_registration_ids_and_validation_limits",
        ),
        "cargo test -p temporalstore-rust context_models_match_cpp_registration_ids_and_validation_limits -- --test-threads=1",
