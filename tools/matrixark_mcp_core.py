...
try:
    from tools.matrixark_mcp_oss_understanding import UNDERSTANDING_LABELS
except ModuleNotFoundError:  # Direct script execution from tools/.
    from matrixark_mcp_oss_understanding import UNDERSTANDING_LABELS


def require_oss_understanding() -> bool:
    try:
        from tools.matrixark_mcp_oss_understanding import require_oss_understanding as _require_oss_understanding
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_oss_understanding import require_oss_understanding as _require_oss_understanding

    return _require_oss_understanding()


def understanding_provider(envelope: Json | None = None) -> str:
    try:
        from tools.matrixark_mcp_oss_understanding import understanding_provider as _understanding_provider
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_oss_understanding import understanding_provider as _understanding_provider

    return _understanding_provider(envelope)


def prototype_vectors(labels: dict[str, str]) -> dict[str, list[float]]:
    try:
        from tools.matrixark_mcp_oss_understanding import prototype_vectors as _prototype_vectors
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_oss_understanding import prototype_vectors as _prototype_vectors

    return _prototype_vectors(labels)


def oss_encoder_rank_labels(text: str, labels: dict[str, str], *, limit: int = 5) -> list[Json]:
    try:
        from tools.matrixark_mcp_oss_understanding import oss_encoder_rank_labels as _oss_encoder_rank_labels
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_oss_understanding import oss_encoder_rank_labels as _oss_encoder_rank_labels

    return _oss_encoder_rank_labels(text, labels, limit=limit)


def oss_encoder_event_type(text: str) -> str:
    try:
        from tools.matrixark_mcp_oss_understanding import oss_encoder_event_type as _oss_encoder_event_type
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_oss_understanding import oss_encoder_event_type as _oss_encoder_event_type

    return _oss_encoder_event_type(text)


def oss_encoder_compact_extraction(envelope: Json, *, prior_context: Json) -> Json:
    try:
        from tools.matrixark_mcp_oss_understanding import oss_encoder_compact_extraction as _oss_encoder_compact_extraction
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_oss_understanding import oss_encoder_compact_extraction as _oss_encoder_compact_extraction

    return _oss_encoder_compact_extraction(envelope, prior_context=prior_context)


def oss_encoder_extract_batch_entities(messages: list[Json], envelope: Json) -> list[Json]:
    try:
        from tools.matrixark_mcp_oss_understanding import oss_encoder_extract_batch_entities as _oss_encoder_extract_batch_entities
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_oss_understanding import oss_encoder_extract_batch_entities as _oss_encoder_extract_batch_entities

    return _oss_encoder_extract_batch_entities(messages, envelope)


def oss_encoder_memory_segments(messages: list[Json]) -> list[Json]:
    try:
        from tools.matrixark_mcp_oss_understanding import oss_encoder_memory_segments as _oss_encoder_memory_segments
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_oss_understanding import oss_encoder_memory_segments as _oss_encoder_memory_segments

    return _oss_encoder_memory_segments(messages)

def extract_batch_entities(messages: list[Json], envelope: Json) -> list[Json]:
    try:
        from tools.matrixark_mcp_extraction_normalization import extract_batch_entities as _extract_batch_entities
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_extraction_normalization import extract_batch_entities as _extract_batch_entities

    return _extract_batch_entities(messages, envelope)


def infer_entity_field_patches(entity_type: str, value: str, text: str) -> list[Json]:
    try:
        from tools.matrixark_mcp_extraction_normalization import infer_entity_field_patches as _infer_entity_field_patches
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_extraction_normalization import infer_entity_field_patches as _infer_entity_field_patches

    return _infer_entity_field_patches(entity_type, value, text)


def clean_patch_value(value: str) -> str:
    try:
        from tools.matrixark_mcp_extraction_normalization import clean_patch_value as _clean_patch_value
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_extraction_normalization import clean_patch_value as _clean_patch_value

    return _clean_patch_value(value)


def canonical_entity_name(entity_type: str, value: str) -> str:
    try:
        from tools.matrixark_mcp_extraction_normalization import canonical_entity_name as _canonical_entity_name
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_extraction_normalization import canonical_entity_name as _canonical_entity_name

    return _canonical_entity_name(entity_type, value)


def dedupe_entities(entities: list[Json]) -> list[Json]:
    try:
        from tools.matrixark_mcp_extraction_normalization import dedupe_entities as _dedupe_entities
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_extraction_normalization import dedupe_entities as _dedupe_entities
...
def ordered_unique(values: list[str]) -> list[str]:
    try:
        from tools.matrixark_mcp_extraction_normalization import ordered_unique as _ordered_unique
    except ModuleNotFoundError:  # Direct script execution from tools/.
        from matrixark_mcp_extraction_normalization import ordered_unique as _ordered_unique
