...
try:
    from tools.matrixark_mcp_runtime_exports import RUNTIME_CONFIG_EXPORTS, runtime_config_exports
except ModuleNotFoundError:  # Direct script execution from tools/.
    from matrixark_mcp_runtime_exports import RUNTIME_CONFIG_EXPORTS, runtime_config_exports
globals().update(runtime_config_exports())
