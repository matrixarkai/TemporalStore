...
REQUIRED_SCRIPT_SNIPPETS = (
    ...
    "export_storage_migration_artifacts.py",
    "storage-migration-artifacts",
    "--features temporal-raft-engine temporal_raft_ --lib",
...
REQUIRED_READINESS_SNIPPETS = (
    ...
    "TemporalRaft-backed data-node and metaserver adapter is available behind the temporal-raft-engine feature",
    "ProductionRaftEngineKind::TemporalRaft",
