...
UNIT_BUILD_TARGETS="${UNIT_BUILD_TARGETS:-common_test stream_test store_test object_store_guardrail_test stream_unittest hash_model_test feature_model_test ips_model_test control_state_hash_model_test cpc_model_test index_test storage_test data_raft_replication_codec_smoke partition_test server_test ms_test smoketest consistency_smoketest}"
