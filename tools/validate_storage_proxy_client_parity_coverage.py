...
REQUIRED_CASES = {
    ...
    "storage_manager_active_eviction_runtime": "active StorageManager eviction runtime",
    "storage_manager_page_gc_dependency_refusal": "page GC dependency refusal",
    "storage_manager_index_gc_thresholds_recovery": "Index GC thresholds and recovery",
    "storage_manager_metrics_admin_phase_reports": "StorageManager metrics/admin phase reports",
    "storage_control_state_context_page_backed_parity": "ControlState/Context page-backed parity",
