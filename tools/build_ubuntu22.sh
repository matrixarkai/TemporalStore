...
MATRIXOBJECTSTORE_COMPAT_INCLUDE_DIR="${MATRIXOBJECTSTORE_COMPAT_INCLUDE_DIR:-}"
...
if [[ -n "${MATRIXOBJECTSTORE_COMPAT_INCLUDE_DIR}" ]]; then
  COMPAT_ARGS+=(-DMATRIXOBJECTSTORE_COMPAT_INCLUDE_DIR="${MATRIXOBJECTSTORE_COMPAT_INCLUDE_DIR}")
fi
if [[ -n "${BRPC_STATIC_LIBRARY}" ]]; then
