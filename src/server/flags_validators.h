...
DEFINE_uint64(bytestore_client_max_write_size, 1024 * 1024 * 1024, "bytestore max size to write");
DEFINE_uint64(bytestore_log_file_num, 5, "bytestore client log file num per log level");
DEFINE_uint64(bytestore_log_file_size_mb, 1024, "bytestore client log file size");
