//! Slot-dump manifest/install-marker file I/O helpers, split from engine.rs.
use super::*;
...
pub(super) fn slot_dump_install_phase_counts(markers: &[SlotDumpInstallMarker]) -> (usize, usize, usize) {
